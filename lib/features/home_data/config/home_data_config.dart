  ...
  static HomeDataConfig clearWarehouseQtyConfig() {
    return const HomeDataConfig(
      ...
      columnTitles: {
        ...
        COL_WAREHOUSE_QTY_INT: '撤回入庫',
        COL_WAREHOUSE_QTY_OUT: '撤回出庫',
        COL_UP_IN_QTY_TIME: '撤回時間',
        COL_QTY_STATE: '狀態',
      },
  ...
  static HomeDataConfig pullQcUncheckedConfig() {
    return const HomeDataConfig(
      ...
      columnTitles: {
        ...
        COL_PROJECT_CODE: '指令号',
        COL_QTY: '總数量',
        COL_WAREHOUSE_QTY_INT: '入庫',
        COL_IN_QC_QTY_TIME: '時間',
        COL_QTY_STATE: '狀態',
      },
      defaultSortColumn: COL_DATE,
      columnFlex: {
